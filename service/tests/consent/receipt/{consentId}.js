...
/**
 * Test for /consent/receipt/{consentId}
 */
Test('/consent/receipt/{consentId}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/consent/receipt/{consentId}']['get']['responses']['200']['schema']);
